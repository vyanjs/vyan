...
Vyanjs is EcmaScript6 UI targeted for enterprise web application and hybrid mobile application SDK with following features.
...
## Display Management
   Vyanjs efficiently does display management of Elements using ViewManager, ViewNavigator, View, Component.  
